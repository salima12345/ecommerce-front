        ...
        <Container>
            <SideNav>
              ...
              <Link href={`/category/${globalCategory._id}`}>&lt; {globalCategory.name}</Link>
               <Link href={`/childCategory/${parentCategory._id}`}>&lt; {parentCategory.name}</Link>
              </PreviousCat>
...
export async function getServerSideProps(context) {
    ...
    return {
      props: {
        ...
        globalCategory: JSON.parse(JSON.stringify(globalCategory)),
